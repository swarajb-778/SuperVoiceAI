  ...
  return (
    <div className="space-y-5">
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    <span className="text-[13px] font-semibold" style={{ color: '#e7e5e4' }}>{agent.name}</span>
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  ...
                  <Button variant="ghost" size="sm"
                    icon={agent.is_active ? <ToggleRight className="w-4 h-4" style={{ color: '#fbbf24' }} /> : <ToggleLeft className="w-4 h-4" style={{ color: '#57534e' }} />}
            ...
            {SUGGESTED_AGENTS.map((s) => (
              ...
              >
                <div className="flex items-center gap-2.5 mb-3">
                  ...
                  <div>
                    <div className="text-[13px] font-semibold leading-tight" style={{ color: '#e7e5e4' }}>{s.name}</div>
                    <div className="text-[11px] capitalize" style={{ color: '#57534e' }}>{s.personality} · {s.voice}</div>
                  </div>
                </div>
                <p className="text-[12px] leading-relaxed mb-3 line-clamp-2" style={{ color: '#78716c' }}>
                  {s.greeting_message}
                </p>
      ...
      <Modal isOpen={!!deleteId} onClose={() => setDeleteId(null)} title="Delete Agent" size="sm">
        <p className="text-[13px] mb-5" style={{ color: '#a8a29e' }}>Are you sure you want to delete this agent? This cannot be undone.</p>
