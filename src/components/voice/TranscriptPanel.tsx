...
export function TranscriptPanel({ entries, className, primaryColor = '#f59e0b' }: TranscriptPanelProps) {
    ...
    return (
      <div className={cn('flex flex-col items-center justify-center h-full gap-2', className)}>
        <div className="w-10 h-10 rounded-full flex items-center justify-center"
          ...
          <MessageSquare className="w-4 h-4" style={{ color: '#44403c' }} />
        </div>
        <p className="text-[11px]" style={{ color: '#44403c' }}>Conversation will appear here</p>
      </div>
    );
  }
        ...
        {entries.map((entry) => (
          ...
          >
            ...
            <div
              ...
              style={entry.role === 'assistant'
                ? { background: `${primaryColor}12`, border: `1px solid ${primaryColor}25`, color: '#d6d3d1', borderTopLeftRadius: 4 }
